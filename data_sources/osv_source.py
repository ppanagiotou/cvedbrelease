...
class OSV_Source(Data_Source):
    ...
    async def update_ecosystems(self):
        ...
        # osv-vulnerabilities is not an ecosystem, see
        # https://github.com/intel/cve-bin-tool/issues/1930
        while "osv-vulnerabilities" in ecosystems:
            ecosystems.remove("osv-vulnerabilities")
